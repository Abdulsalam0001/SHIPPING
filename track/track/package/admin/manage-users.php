...
<html lang="en">
  <head>
    ...
    <meta name="description" content="stop sending the link to people">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  <th>Sno.</th>
                                  <th class="hidden-phone">Name/location</th>
                             ...
                             <th>Reg. Date</th>                                                                  
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td><?php echo $row['senderc'];?></td>
                                  <td><?php echo $row['sendera'];?></td> 
                                   <td><?php echo $row['sendern'];?></td>
                                  <td>map data</td>
