...
<html lang="en">
  ...
  <head>
    ...
    <title>World Delivery Network</title>
        <meta name="description" content="World Delivery Network is a delivery company based in the United states, That helps you send and recieve goods anywhere in the world virus free ">
    <meta charset="UTF-8">
    ...
    <div class="site-wrap" id="home-section">
      ...
      <div class="top-bar">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <a href="#" class=""><span class="mr-2  icon-envelope-open-o"></span> <span class="d-none d-md-inline-block">support@worlddeliverynetwork.com</span></a>
              <span class="mx-md-2 d-inline-block"></span>
              <a href="tel://<? echo $num ;?>" class=""><span class="mr-2  icon-phone"></span> <span class="d-none d-md-inline-block"><?php echo $num;?></span></a>
      ...
      <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="site-logo">
              <a href="../" class="text-black"><span class="text-primary">WDN</a>
            </div>
          ...
          <div class="container">
            <div class="row align-items-center justify-content-center text-center">
              <div class="col-lg-6">
                ...
                <p class="mb-5">Use secure code to track package's current location </p>
            ...
            <div class="owl-carousel owl-all">
              ...
              <div class="service text-center">
                ...
                <div class="px-md-3">
                  ...
                  <p>Speed is essential for business , here at world delivery network we make sure your packages arrives on time </p>
                </div>
              </div>
              <div class="service text-center">
                ...
                <div class="px-md-3">
                  ...
                  <p> At WDN , we provide a team that will help you with all your inquires, our staffs would gladly have a phone conversation with you or send us a mail </p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row d-flex no-gutters align-items-stretch">
            ...
            <div class="col-lg-5 mr-auto p-lg-5 mt-4 mt-lg-0 order-lg-1" data-aos="fade-right" data-aos-delay="">
              <h2 class="mb-4 text-black">Why WDN</h2>
          ...
          <div class="owl-carousel nonloop-block-13">
            ...
            <div>
              <div class="block-testimony-1 text-center">
                ...
                <blockquote class="mb-4">
                  <p>&ldquo;I am so glad I found out about WDN , I can easily send Valuables to my loved ones .&rdquo;</p>
                </blockquote>
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-7">
                ...
                <p>At World Delivery we make it a priority to make sure every package is delivered to the appropiate location at the right time.</p>
              </div>
          ...
          <div class="col-md-12">
            <div class="border-top pt-5">
              <p>
                ...
                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | World Delivery Network
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
          </div>
