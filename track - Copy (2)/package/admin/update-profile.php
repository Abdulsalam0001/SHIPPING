                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="investment" value="<?php echo $row['investment'];?>" >
                                                ...
                                                <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Sender Address </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="sendera" value="<?php echo $row['sendera'];?>" >
                              </div>
                          </div>                           
                                                         <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Package percentage </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="senderc" value="<?php echo $row['senderc'];?>" >
                              </div>
                          </div>                               <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Reciever Name/address</label>
                              <div class="col-sm-10">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Current Location </label>
                              <div class="col-sm-10">
