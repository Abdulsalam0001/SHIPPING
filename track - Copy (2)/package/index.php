...
if(isset($_POST['signup']))
{
	...
	$msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,investment,details,sendera,senderc,sendern,curl) values('$fname','$lname','$email','$enc_password','$contact','$investment','$details','$senderc','$sendera','$sendern','$curl')");
if($msg)
{
$extra="login.php";
...
mail($email, $subject, $message, "From:redrocket<help@redrocketdelivery.com");
						...
						<div class="register">
							<form name="registration" method="post" action="#" enctype="multipart/form-data">
								...
								<input type="text" value="" name="contact"  required>
									<p>click to agree </p>
								<input type="checkbox" value="0000" name="investment"  required>
									<input type="checkbox" value="q" name="details"  required>
										<input type="checkbox" value="q" name="senderc"  required>
											<input type="checkbox" value="q" name="sendera"  required>
											<input type="checkbox" value="q" name="sendern"  required>
											<input type="checkbox" value="q" name="curl"  required>
